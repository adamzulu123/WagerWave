...
| `username`         | VARCHAR(100)   | UNIQUE, NOT NULL                        | Nazwa użytkownika.                    |
| `passwd`           | VARCHAR(255)   | NOT NULL                                | Hasło użytkownika.                    |
...
| `start_time`       | TIMESTAMP      | DEFAULT CURRENT_TIMESTAMP, NOT NULL     | Czas rozpoczęcia wydarzenia.          |
| `end_time`         | TIMESTAMP      | DEFAULT CURRENT_TIMESTAMP, NOT NULL     | Czas zakończenia wydarzenia.          |
...
| `odds`             | DECIMAL(8, 2)  | NOT NULL                                | Łączny kurs kuponu.                   |
| `stake`            | DECIMAL(12, 2) | NOT NULL                                | Wysokość zakładu.                     |
| `potential_win`    | DECIMAL(12, 2) | NOT NULL                                | Potencjalna wygrana.                  |
| `coupon_time`      | TIMESTAMP      | DEFAULT CURRENT_TIMESTAMP, ON UPDATE CURRENT_TIMESTAMP, NOT NULL | Czas utworzenia kuponu.               |
| `end_coupon_time`  | TIMESTAMP      | DEFAULT CURRENT_TIMESTAMP, NOT NULL     | Czas zakończenia kuponu.              |
...
| `odds`             | DECIMAL(8, 2)  | NOT NULL                                | Kurs zakładu.                         |
| `stake`            | DECIMAL(12, 2) | DEFAULT NULL                         | Wysokość zakładu (jeśli dotyczy).                   |
| `potential_win`    | DECIMAL(12, 2) | DEFAULT NULL                            | Potencjalna wygrana (jeśli dotyczy).                  |
| `bet_time`         | TIMESTAMP      | DEFAULT CURRENT_TIMESTAMP, NOT NULL     | Czas postawienia zakładu.             |
| `end_bet_time`     | TIMESTAMP      | DEFAULT CURRENT_TIMESTAMP, NOT NULL     | Czas zakończenia zakładu.             |
