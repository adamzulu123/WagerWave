...
extends JpaRepository<User, Integer> - ten interfejs zawiera metody do komunikacji z baza danych
...
Optional<User> - ozn, że może zawierac obiekt użytkownka lub byc pusty (jak nie ma go w bazie)
 */
